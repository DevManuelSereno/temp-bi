...
export const MOCK_TOP_ITEMS: TopItem[] = [
    {
        ...
        value: 142500,
        formattedValue: "R$ 142.500",
        change: 18.2,
        metadata: { category: "Estética" },
    },
    {
        id: "2",
        rank: 2,
    ...
    },
    {
        id: "4",
        rank: 4,
        label: "Limpeza de Pele Deep",
        value: 76200,
        formattedValue: "R$ 76.200",
        change: 8.7,
        metadata: { category: "Facial" },
    },
    {
        id: "5",
        rank: 5,
...
export const MOCK_INSIGHTS: Insight[] = [
    ...
    },
    {
        ...
        type: "opportunity",
        severity: "info",
        title: "Harmonização com alta demanda",
        description:
            "Harmonização Facial cresceu 18% — considere expandir horários ou adicionar profissional.",
        metric: "+18,2%",
